                    ...
                    <div class="panel-body profile-information">
                       <div class="col-md-3">
                           <div class="profile-pic text-center">
                               <img src="{{ URL::to('bucket')}}/images/lock_thumb.jpg" alt=""/>
                           </div>
                       </div>
                       <div class="col-md-6">
                           <div class="profile-desk">
                               <h1>Aston Tukimin</h1>
                               <span class="text-muted">Product & Property Rights Manager at <a href="{{URL::to( 'company/profile' )}}">PT. Holycow ! International</a>
                               </span>
                               <h4></h4>
                               <p>
                        ...
                        <div class="tab-content tasi-tab">
                            <div id="overview" class="tab-pane active">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="recent-act">
                                            ...
                                            <div class="activity-desk">
                                                <h2>1 Hour Ago</h2>
                                                <p>Send in documents required for PT. CGI investment valuation</p>
                                            </div>
                                            ...
                                            <div class="activity-desk">
                                                ...
                                                <p>Completed Coffee meeting with <a href="#" class="terques">John McNamara</a> regarding the Product Patent for Floating Lawnmower</p>
                                            </div>
                                            ...
                                            <div class="activity-desk">
                                                ...
                                                <p>3 photos uploaded from client's page</p>
                                                <div class="photo-gl">
                                                    <a href="#">
                                                        <img src="{{ URL::to('bucket')}}/images/sm-img-1.jpg" alt=""/>
                                                    </a>
                                                    <a href="#">
                                                        <img src="{{ URL::to('bucket')}}/images/sm-img-2.jpg" alt=""/>
                                                    </a>
                                                    <a href="#">
                                                        <img src="{{ URL::to('bucket')}}/images/sm-img-3.jpg" alt=""/>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="prf-box">
                                            <h3 class="prf-border-head">Projects in progress</h3>
                                            <div class=" wk-progress">
                                                <div class="col-md-5">PT. CGI investment</div>
                                                <div class="col-md-5">
                                                    <div class="progress  ">
                                            ...
                                            <div class=" wk-progress">
                                                <div class="col-md-5">Apple Center Opening</div>
                                                <div class="col-md-5">
                                                    <div class="progress ">
                                        ...
                                        <div class="prf-box">
                                            <h3 class="prf-border-head">revenue performance status</h3>
                                            <div class=" wk-progress pf-status">
                                                <div class="col-md-8 col-xs-8">Total Revenue from this Client</div>
                                        ...
                                        <div class="prf-box">
                                            ...
                                            <div class=" wk-progress tm-membr">
                                                <div class="col-md-2 col-xs-2">
                                                    <div class="tm-avatar">
                                                        <img src="{{ URL::to('bucket')}}/images/avatar-mini-2.jpg" alt=""/>
                                                    </div>
                                                </div>
                                                <div class="col-md-7 col-xs-7">
                                                    <span class="tm">John Boltana</span>
                                            ...
                                            <div class=" wk-progress tm-membr">
                                                <div class="col-md-2 col-xs-2">
                                                    <div class="tm-avatar">
                                                        <img src="{{ URL::to('bucket')}}/images/avatar-mini-3.jpg" alt=""/>
                                                    </div>
                                                </div>
                                                <div class="col-md-7 col-xs-7">
                                                    <span class="tm">John Boltana</span>
                                            ...
                                            <div class=" wk-progress tm-membr">
                                                <div class="col-md-2 col-xs-2">
                                                    <div class="tm-avatar">
                                                        <img src="{{ URL::to('bucket')}}/images/avatar-mini-4.jpg" alt=""/>
                                                    </div>
                                                </div>
                                                <div class="col-md-7 col-xs-7">
                                                    <span class="tm">John Boltana</span>
